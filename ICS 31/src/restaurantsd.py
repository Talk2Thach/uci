...
Restaurant Collection Program --- Choose one
 ...
 c:  Change the retaurants' prices in the collection to user-input number
...
def handle_commands(C: list) -> list:
    ...
    while True:
        ...
        if response=="q":
            ...
            n = float(input("Enter a new price number: "))
...
def Restaurant_change_price(self: Restaurant, new_price:float)-> Restaurant:
    '''Return a the restaurant with changed prices, replaced by new_price'''
